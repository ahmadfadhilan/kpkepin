...
$query = $conn->query("SELECT nama_kategori,id_bayar,coa,nama_bayar,jumlah,tanggal FROM pembayaran a INNER JOIN kategori_bayar b 
...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Biaya Penerapan</h4> </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="#">Biaya Penerapan</a></li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
     <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="box-title">Data Penerapan</h3>
                    </div>
                    <div class="col-sm-6">
                        <button class="btn btn-success btn-sm pull-right" onclick="tambah()">Tambah</button>
                         <button class="btn btn-warning btn-sm pull-right" onclick="laporan()" style="margin-right: 5px;">Laporan Penerapan</button>
                    </div>
                </div>
        ...
        <form class="form-horizontal form-material" id="form">
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" placeholder="COA" class="form-control form-control-line" name="coa" id="coa"> 
                    <span class="help-block"></span>
                </div>

            </div>
            <div class="form-group">
                <label class="col-md-12">Nama Pembayaran</label>
                <div class="col-md-12">
                    <input type="text" placeholder="Nama Pembayaran" class="form-control form-control-line" name="nama_bayar" id="nama_bayar"> 
                    <span class="help-block"></span>
                </div>
...
function edit_pengeluaran(id){
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('.modal-title').text('Edit Penerapan '); // Set title to Bootstrap modal title
