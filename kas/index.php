...
SUM(biaya) as jumlah_pengeluaran
from penyerapan
INNER JOIN kas_masuk 
ON (penyerapan.judul_program_kerja=kas_masuk.nama)");
...
<head>
    ...
    <title>Aplikasi Permintaan Pengadaan</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="fa fa-bars"></i></a>
                <div class="top-left-part"><a class="logo" href="<?= base_url ?>"><b><img src="<?php echo base_url ?>assets/pixeladmin-lite/plugins/images/pln.png" alt="home" /></b><span class="hidden-xs"><img src="<?php echo base_url ?>assets/pixeladmin-lite/plugins/images/logo1.png" alt="home" /></span></a></div>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li>
                        <a class="profile-pic" href="#"> <img src="<?php echo base_url ?>assets/pixeladmin-lite/plugins/images/users/admin.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs"><?= $_SESSION['user'] ?></b> </a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#dana_masuk" id="kas_masuk" class="waves-effect"><i class="fa fa-bank fa-fw" aria-hidden="true"></i><span class="hide-menu"> Anggaran</span></a>
                    </li>

                    <li>
                        <a href="#penyerapan" id="penyerapan" class="waves-effect"><i class="fa fa-money fa-fw" aria-hidden="true"></i><span class="hide-menu"> Penyerapan</span></a>
                    </li>

                    <li>
                        <a href="#kategori_pengeluaran" id="kategori_pengeluaran" class="waves-effect"><i class="fa fa-th-large fa-fw" aria-hidden="true"></i><span class="hide-menu">Kategori Penerapan</span></a>
                    </li>
                    <li>
                        <a href="#pengeluaran" id="pengeluaran" class="waves-effect"><i class="fa fa-shopping-bag fa-fw" aria-hidden="true"></i><span class="hide-menu">Penerapan</span></a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                        ...
                        <div class="white-box">
                            <div class="col-in row">
                                <div class="col-md-12 col-sm-12 col-xs-12"> <i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
                                    <h5 class="text-center text-muted vb">Total Anggaran</h5>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <div class="col-in row">
                                <div class="col-md-12 col-sm-12 col-xs-12"> <i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
                                    <h5 class="text-center text-muted vb">Total Penyerapan</h5>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <div class="col-in row">
                                <div class="col-md-12 col-sm-12 col-xs-12"> <i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
                                    <h5 class="text-center text-muted vb">Total Sisa</h5>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> <?php echo date('Y'); ?> &copy; Aplikasi Permintaan Pengadaan </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
    ...
    $(document).ready(function() {
        ...
        $.toast({
            heading: 'Selamat Datang di Aplikasi Permintaan Pengadaan Admin',
            text: 'Aplikasi Permintaan Pengadaan',
            position: 'top-right',
            loaderBg: '#6495ED',
            icon: 'info',
            hideAfter: 3500,
        ...
        Highcharts.chart('crt', {
              ...
              series: [{
                  ...
                  <?php
                                ...
                                echo "['Seluruh Anggaran',   ".$pemasukan.",'false'],";
                                echo "['Penyerapan',   ".$pengeluaran.",'false'],";
                                echo "['Sisa Anggaran',   ".$saldo.",'false'],";
      ...
      $("#penyerapan").click(function(){
        $("#kontenku").load("<?php echo base_url ?>page/penyerapan.php");
      });
